...
export const fetchSearchVideo = async (searchId, nextPageToken, maxResults = 24) => {
    try {
...
export const fetchChannelVideo = async (channelId, searchType, nextPageToken, maxResults = 24) => {
    try {
        const res = await axios.get(`${BASE_URL}`, {
            params: {
                channelId: channelId,
